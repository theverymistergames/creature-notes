...
namespace MTAssets.UltimateLODSystem.Editor
{
    ...
    public class Menu : MonoBehaviour
    {
        ...
        static void EnableLodsInThisScene()
        {
            ...
            UltimateLevelOfDetail[] ulods = Object.FindObjectsByType<UltimateLevelOfDetail>(FindObjectsInactive.Include, FindObjectsSortMode.None);
#endif
#if !UNITY_2023_1_OR_NEWER
        ...
        [MenuItem("Tools/MT Assets/Ultimate LOD System/Discord Community", false, 30)]
