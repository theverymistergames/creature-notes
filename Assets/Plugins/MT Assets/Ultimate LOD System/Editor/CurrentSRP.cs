...
namespace MTAssets.UltimateLODSystem.Editor
{
    ...
    public class CurrentSRP
    {
        ...
        public static void ApplyChanges(bool haveAnotherRenderPipelinePackage, string renderPipelinePackageName)
        {
            ...
            string currentRpTextTrue = File.ReadAllText("Assets/Plugins/MT Assets/Ultimate LOD System/Scripts/ProcessedByCurrentSRPInEditor/VariableTrue.txt");
            string currentRpTextFalse = File.ReadAllText("Assets/Plugins/MT Assets/Ultimate LOD System/Scripts/ProcessedByCurrentSRPInEditor/VariableFalse.txt");
            ...
            if (haveAnotherRenderPipelinePackage == true)
                ...
                {
                    File.WriteAllText("Assets/Plugins/MT Assets/Ultimate LOD System/Scripts/ProcessedByCurrentSRPInEditor/CurrentRenderPipeline.cs", currentRpTextTrue.Replace("%package%", renderPipelinePackageName));
            ...
            if (haveAnotherRenderPipelinePackage == false)
                ...
                {
                    File.WriteAllText("Assets/Plugins/MT Assets/Ultimate LOD System/Scripts/ProcessedByCurrentSRPInEditor/CurrentRenderPipeline.cs", currentRpTextFalse.Replace("%package%", renderPipelinePackageName));
                    AssetDatabase.Refresh();
                }
        }
    }
