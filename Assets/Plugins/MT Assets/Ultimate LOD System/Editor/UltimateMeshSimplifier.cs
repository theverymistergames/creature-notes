    ...
    public class UltimateMeshSimplifier : EditorWindow
    {
        ...
        */
        ...
        public static void OpenWindow(GameObject gameObjectWithMeshToOpen, Mesh meshToOpen)
        {
            ...
            window.minSize = new Vector2(400, 655);
            window.maxSize = new Vector2(400, 655);
        ...
        void RunMeshSimplificator()
        {
            ...
            if (AssetDatabase.IsValidFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes") == false)
                AssetDatabase.CreateFolder("Assets/Plugins/MT Assets/_AssetsData", "Meshes");
            if (AssetDatabase.IsValidFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes/Temp") == false)
                AssetDatabase.CreateFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes", "Temp");
            ...
            for (int i = 0; i < simplifiedMeshes.Length; i++)
            {
                ...
                AssetDatabase.CreateAsset(previewMeshesCurrentOnTempFolder[i], "Assets/Plugins/MT Assets/_AssetsData/Meshes/Temp/generatedTempMesh_" + i.ToString() + ".asset");
            }
            ...
            previewRenderUtility.camera.transform.rotation = Quaternion.Euler(0, 0, 0);
            previewRenderUtilityMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Ultimate LOD System/Editor/Material/Preview.mat", typeof(Material));
        ...
        static void LoadThePreferences(UltimateMeshSimplifier instance)
        {
            ...
            meshSimplifierPreferences = (UMeshSimplifierPreferences)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/_AssetsData/Preferences/UMeshSimplifierPreferences.asset", typeof(UMeshSimplifierPreferences));
            ...
            if (meshSimplifierPreferences != null)
            {
                ...
                {
                    AssetDatabase.DeleteAsset("Assets/Plugins/MT Assets/_AssetsData/Preferences/UMeshSimplifierPreferences.asset");
            ...
            if (meshSimplifierPreferences == null)
            {
                ...
                AssetDatabase.CreateAsset(meshSimplifierPreferences, "Assets/Plugins/MT Assets/_AssetsData/Preferences/UMeshSimplifierPreferences.asset");
                AssetDatabase.SaveAssets();
                AssetDatabase.Refresh();
            }
        }
